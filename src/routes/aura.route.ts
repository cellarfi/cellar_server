...
router.post(
  '/asset',
  async (
    req: Request<{}, {}, GetSignaturesForAssetParams>,
    res: Response
  ): Promise<any> => {
    try {
      const { id } = req.body
...
router.post(
  '/asset/proof',
  async (
    req: Request<{}, {}, GetAssetProofParams>,
    res: Response
  ): Promise<any> => {
    try {
      const { id } = req.body
...
router.post(
  '/assets/batch',
  async (
    req: Request<{}, {}, GetAssetsByBatchParams>,
    res: Response
  ): Promise<any> => {
    try {
...
router.post(
  '/assets/proof/batch',
  async (
    req: Request<{}, {}, GetAssetProofBatchParams>,
    res: Response
  ): Promise<any> => {
    try {
      // Expect an array of asset IDs in the request body
...
router.post(
  '/assets/owner',
  async (
    req: Request<{}, {}, GetAssetsByOwnerParams>,
    res: Response
  ): Promise<any> => {
    try {
...
router.post(
  '/assets/authority',
  async (
    req: Request<{}, {}, GetAssetsByAuthorityParams>,
    res: Response
  ): Promise<any> => {
    try {
...
router.post(
  '/assets/group',
  async (
    req: Request<{}, {}, GetAssetsByGroupParams>,
    res: Response
  ): Promise<any> => {
    try {
...
router.post(
  '/assets/creator',
  async (
    req: Request<{}, {}, GetAssetsByCreatorParams>,
    res: Response
  ): Promise<any> => {
    try {
      const {
...
router.post(
  '/token/accounts',
  async (
    req: Request<{}, {}, GetTokenAccountsParams>,
    res: Response
  ): Promise<any> => {
    try {
      const {
...
router.post(
  '/assets/search',
  async (
    req: Request<{}, {}, SearchAssetsParams>,
    res: Response
  ): Promise<any> => {
    try {
      const {
